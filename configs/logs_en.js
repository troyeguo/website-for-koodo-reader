const changeLogs = [
  ...
  },
  {
    ...
    new: [
      ...
      "View mode automatically changes from double to single when window size is smaller than 780px",
      "Add text align option",
      "Add close button to popup menu",
      "Main window will be hidden while reading",
      "Add file icons to epub, mobi, azw3, pdf and txt",
      "Popup menu now supports searching in the book, searching on the internet and speaking the text ",
